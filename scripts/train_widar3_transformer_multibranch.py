"""Train and evaluate a Transformer three-branch Widar3.0 baseline."""
...
def main(argv: list[str] | None = None) -> int:
    parser = build_parser()
    parser.description = "Train the Widar3.0 Transformer multibranch baseline."
    parser.set_defaults(run_name="transformer_multibranch")
