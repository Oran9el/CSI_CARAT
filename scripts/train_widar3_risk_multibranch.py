"""Train and evaluate a risk-aware three-branch Widar3.0 baseline."""
...
from csi_carat.models.baselines import MultiBranchCnnClassifier
...
def main(argv: list[str] | None = None) -> int:
    parser = build_parser()
    parser.description = "Train the Widar3.0 risk-aware multibranch baseline."
    parser.set_defaults(run_name="risk_multibranch")
